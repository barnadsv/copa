...
# Require the class.
require_once('../vendor/WhatsAPI/src/php/whatsprot.class.php');
 ...
 */
$userPhone        = '556184797171';           # Telephone number including the country code without '+' or '00'.
$userIdentity     = '35:52:57:05:08:84:39:1'; # This is tipically the IMEI number.
                                              # If you are using an iOS device you should input your WLAN MAC address.
$userName         = 'Leonardo Teste';         # This is the username displayed by WhatsApp clients.

$destinationPhone = '556185142193';       # Destination telephone number including the country code without '+' or '00'.
                                          # For groups: [phone number]-[group id].
$debug = TRUE;

# Create a instance of WhastProt.
