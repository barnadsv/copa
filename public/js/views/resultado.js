                ...
                palpites.fetch({
                    success: function (data, response, options) {
                        ...
                        data.models.sort(function(a, b) {
                            if (a.usuario.attributes.nome < b.usuario.attributes.nome) return -1;
                            if (a.usuario.attributes.nome > b.usuario.attributes.nome) return 1;
                            if (parseInt(a.partida.attributes.num_partida,10) < parseInt(b.partida.attributes.num_partida,10)) return -1;
                            if (parseInt(a.partida.attributes.num_partida,10) > parseInt(b.partida.attributes.num_partida,10)) return 1;
                            return 0;
                        });
